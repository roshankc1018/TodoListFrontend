...
var SliderComponent = /** @class */ (function (_super) {
    ...
    function SliderComponent(localization, injector, renderer, ngZone, changeDetector, hostElement) {
        ...
        _this.onWrapClick = function (args) {
            ...
            dom_utils_1.invokeElementMethod(_this.draghandle, 'focus');
        };
        /**
         * @hidden
         */
    ...
    Object.defineProperty(SliderComponent.prototype, "currentValue", {
         ...
         */
        get: function () {
            return utils_1.isPresent(this.value) ? this.value.toString() : '';
        },
        enumerable: true,
        configurable: true
    });
    ...
    SliderComponent.prototype.focus = function () {
        if (!this.disabled) {
            ...
            dom_utils_1.invokeElementMethod(this.draghandle, 'focus');
    ...
    SliderComponent.prototype.blur = function () {
        this.focusChangedProgrammatically = true;
        dom_utils_1.invokeElementMethod(this.draghandle, 'blur');
        this.handleBlur();
        this.focusChangedProgrammatically = false;
    };
    ...
    tslib_1.__decorate([
        core_1.ViewChild('draghandle', { static: true }),
        tslib_1.__metadata("design:type", core_1.ElementRef)
    ], SliderComponent.prototype, "draghandle", void 0);
    tslib_1.__decorate([
        core_1.ViewChild('decreaseButton', { static: false }),
        tslib_1.__metadata("design:type", core_1.ElementRef)
    ], SliderComponent.prototype, "decreaseButton", void 0);
    tslib_1.__decorate([
        core_1.ViewChild('increaseButton', { static: false }),
        tslib_1.__metadata("design:type", core_1.ElementRef)
    ...
    SliderComponent = SliderComponent_1 = tslib_1.__decorate([
        core_1.Component({
            ...
            providers: [
                ...
                { multi: true, provide: forms_1.NG_VALUE_ACCESSOR, useExisting: core_1.forwardRef(function () { return SliderComponent_1; }) },
