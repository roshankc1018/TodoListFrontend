    ...
    TextAreaDirective = TextAreaDirective_1 = tslib_1.__decorate([
        core_1.Directive({
            providers: [{
                    ...
                    useExisting: core_1.forwardRef(function () { return TextAreaDirective_1; }),
                    multi: true
                }, {
        ...
        tslib_1.__param(5, core_1.Optional()), tslib_1.__param(5, core_1.Inject(kendo_angular_l10n_1.RTL)),
        tslib_1.__metadata("design:paramtypes", [core_1.Renderer2,
            core_1.ElementRef,
            core_1.NgZone,
            core_1.ChangeDetectorRef,
            core_1.Injector, Boolean])
    ], TextAreaDirective);
