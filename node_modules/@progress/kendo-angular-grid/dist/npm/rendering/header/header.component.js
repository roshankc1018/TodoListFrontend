...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.onHeaderKeydown = function (column, args) {
        if (args.keyCode === kendo_angular_common_1.Keys.ArrowDown && args.altKey && this.showFilterMenu) {
            args.preventDefault();
        ...
        if (args.keyCode === kendo_angular_common_1.Keys.ArrowDown && args.altKey && this.showColumnMenu(column)) {
            args.preventDefault();
            args.stopImmediatePropagation();
    ...
    tslib_1.__decorate([
        core_1.ViewChildren(filter_menu_component_1.FilterMenuComponent),
        tslib_1.__metadata("design:type", core_1.QueryList)
    ], HeaderComponent.prototype, "filterMenus", void 0);
    tslib_1.__decorate([
        core_1.ViewChildren(column_menu_component_1.ColumnMenuComponent),
        tslib_1.__metadata("design:type", core_1.QueryList)
